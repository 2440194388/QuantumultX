...
if (
 ...
 $.msg(jsname, `qqreadtimeurl${jbid}: 获取时长url: 成功🎉`, ``);
  ...
  else if ($request &&$request.body.indexOf("bookDetail_bottomBar_read_C")>=0&&$request.body.indexOf("bookLib2_bookList_bookClick_C")>=0&&$request.body.indexOf("bookRead_show_I")>=0){
