...
if (
 ...
 $.msg(jsname, `qqreadtimeurl${jbid}: 获取时长url: 成功🎉`, ``);
  ...
  if ($request &&$request.body.indexOf("bookDetail_bottomBar_read_C")>=0&&$request.body.indexOf("bookLib2_bookList_bookClick_C")>=0&&$request.body.indexOf("bookRead_show_I")>=0){
  ...
  $.log(
      `[${jsname}] 获取时长header: 成功,qqreadtimeheaderVal: ${$request.body}`
    );
}
// prettier-ignore
